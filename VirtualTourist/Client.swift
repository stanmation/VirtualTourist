...
class Client: NSObject {
    ...
    // pick a set of images from random page no
    private func displayImageFromFlickrBySearch(methodParameters: [String:AnyObject], withPageNumber: Int, completionHandler: (results: [String], errorString: String?) -> Void) {
        ...
        let task = session.dataTaskWithRequest(request) { (data, response, error) in
            ...
            if photosArray.count == 0 {
                ...
                for photoData in photosArray {
                    let photoDictionary = photoData as [String: AnyObject]
                ...
                completionHandler(results: imageUrlStrings, errorString: "failed in getting image data")
